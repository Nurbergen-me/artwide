...
const rulesList = [
    {
        id: 1,
        text: `
        <p><b>Register &amp; Get Verified:</b> Sign up for an account
        ...
        an exclusive community with enhanced features and privileges.</p>
        `
    },{
        id: 2,
        text: `
        <p><b>Preview Auction: </b> Subscribe for notifications and be
        ...
        inquiries about specific lots. </p>
        `
    },{
        id: 3,
        text: `
        <p><b>Bidding Open:</b> Ready to bid? Our user-friendly
        ...
        id: 4,
        text: `
        <p><b>Lots Begin Closing: </b> The scheduled closing time of
        ...
        and track lots in the “My Bids” section of your account.</p>
        `
    },{
        id: 5,
        text: `
        <p><b>Payment:</b> Congratulations! If you’re successful in an
        ...
        id: 6,
        text: `
        <p><b>Collection, Shipping, and Storage: </b> Following your
