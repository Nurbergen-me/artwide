                ...
                <DialogContent>
                    <DialogHeader>
                        <DialogTitle className="popup__title popup__mtitle">
                            Write to Artwide support
                        </DialogTitle>
                    </DialogHeader>
                    <Form {...form}>
                        <form onSubmit={form.handleSubmit(onSubmit)} className="flex flex-col gap-[1.6vw] max-md:px-[4.26vw] max-md:gap-[6.4vw] overflow-auto max-md:py-[10vw] max-md:h-[calc(100vh-15vw)]">
                            <FormField
                            ...
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        ...
                                        <FormControl>
                                            <Textarea
                                                placeholder="Please provide as much details as possible for our support team to assist you the best"
